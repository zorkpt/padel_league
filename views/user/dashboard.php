...
<main class="flex-grow">
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            <a href="/league/join"
               class="mx-auto unsubscribe-button rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-600">
